...
Установка монстра (недалеко от начального положения игрока)
    >>> testing(socket, 'addmon hellokitty 21 0 1 "Happy python-prac exam day!"')
